...
class AssociationLoader < ::GraphQL::Batch::Loader
  ...
  # rubocop:disable Metrics/MethodLength, Lint/UselessAssignment, Lint/ShadowingOuterLocalVariable
    ...
    ::ActiveRecord::Associations::Preloader.new.preload(
      ...
      if preloader.is_a?(::ActiveRecord::Associations::Preloader::AlreadyLoaded)
        ...
        raise ArgumentError,
              ...
              'To resolve this problem add a scoped association ' \
              '(e.g., `has_many :records, -> { scope_name }, ...`) to the model'
      end
  ...
  # rubocop:enable Metrics/MethodLength, Lint/UselessAssignment, Lint/ShadowingOuterLocalVariable
